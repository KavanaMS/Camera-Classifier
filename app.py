...
class App:
    ...
    def predict(self, frame):
        ...
        img.thumbnail((150, 150))
        img = np.array(img)
        img = img.reshape((150, 113))  # or img.reshape((150, 113, 1)) depending on your model
...
# In model.py
    #def train_model(self, counters): 
     #   for counter in counters:
      #      img = Image.open(counter['image_path'])
       #     img.thumbnail((150, 150))
        #    img = np.array(img)
         #   img = img.reshape((150, 113))  # or img.reshape((150, 113, 1)) depending on your model
    ...
    def train_model(self, counters):
        for counter in counters:
            img = cv2.imread(counter['image_path'])
            # Make changes here
            img = img.resize(16950)  # or img = img.reshape((130, 130, 3)) depending on your requirements
            #... rest of your code...